...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="hidden" name="invoiceDetails[' + counter + '].productType" id="prodType' + counter + '"   /><input type="text" class="form-control" style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  name="invoiceDetails[' + counter + '].hsn" id="hsn' + counter + '"/></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  class="form-control" name="invoiceDetails[' + counter + '].uom" id="uom' + counter + '"/></td>';
        cols += '<td><input type="text" required style="text-align: center" class="form-control" required name="invoiceDetails[' + counter + '].qty" id="qty' + counter + '"/></td>';
        
        cols += '<td><input type="text" required style="text-align: center" class="form-control" required name="invoiceDetails[' + counter + '].price" id="price' + counter + '" onblur="calculateRowGSTTotal(' + counter + ')"/></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  class="form-control" name="invoiceDetails[' + counter + '].amount" id="amount' + counter + '" /></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1"   required  class="form-control" name="invoiceDetails[' + counter + '].cgstPerc" id="cgstPerc' + counter + '" onblur="calculateRowGSTTotal(' + counter + ')" value="'+cgstPerc+'"/></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  class="form-control" name="invoiceDetails[' + counter + '].cgstAmount" id="cgstAmt' + counter + '"/></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1"   required  class="form-control" name="invoiceDetails[' + counter + '].sgstPerc" id="sgstPerc' + counter + '" onblur="calculateRowGSTTotal(' + counter + ')"  value="'+sgstPerc+'"/></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  class="form-control" name="invoiceDetails[' + counter + '].sgstAmount"  id="sgstAmt' + counter + '" /></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1"   required  class="form-control" name="invoiceDetails[' + counter + '].igstPerc" id="igstPerc' + counter + '" onblur="calculateRowGSTTotal(' + counter + ')" value="'+igstPerc+'"/></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  class="form-control" name="invoiceDetails[' + counter + '].igstAmount" id="igstAmt' + counter + '" /></td>';
        cols += '<td><input type="text" required style="text-align: center;background-color: #fff !important" tabindex="-1" readonly  required  class="form-control" name="invoiceDetails[' + counter + '].totalAmountAfterTax" id="totalAmountAfterTax' + counter + '"/></td>';
